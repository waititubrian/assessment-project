      ...
      <div className="flex min-h-screen flex-col">
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
            <div className="container px-4 md:px-6">
              <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
                {/* User Profiles Card - Clickable */}
                <Link href="/login?callbackUrl=/users" className="block group">
                  <div className="space-y-4 p-6 rounded-lg transition-colors hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer">
                    <div className="inline-block rounded-lg bg-gray-100 p-2 dark:bg-gray-800 group-hover:bg-gray-300 dark:group-hover:bg-gray-600">
                      <svg
                ...
                {/* Albums Card - Clickable */}
                <Link href="/login?callbackUrl=/albums" className="block group">
                  <div className="space-y-4 p-6 rounded-lg transition-colors hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer">
                    <div className="inline-block rounded-lg bg-gray-100 p-2 dark:bg-gray-800 group-hover:bg-gray-300 dark:group-hover:bg-gray-600">
                      <svg
                          className="h-6 w-6 text-gray-500 dark:text-gray-400"
                ...
                {/* Photos Card - Clickable */}
                <Link href="/login?callbackUrl=/photos" className="block group">
                  <div className="space-y-4 p-6 rounded-lg transition-colors hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer">
                    <div className="inline-block rounded-lg bg-gray-100 p-2 dark:bg-gray-800 group-hover:bg-gray-300 dark:group-hover:bg-gray-600">
                      <svg
                          className="h-6 w-6 text-gray-500 dark:text-gray-400"
        ...
        <footer className="flex h-16 items-center border-t px-4 lg:px-6">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            © {new Date().getFullYear()} Assessment Project. All rights reserved.
          </p>
        </footer>
      </div>
  )
